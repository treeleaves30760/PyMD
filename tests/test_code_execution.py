...
"""
        ...
        test_utils.assert_contains(html, '<p>Sum: 15</p>')

        print(
            f"✅ Simple code execution test passed - output saved to {output_file}")
...
"""
        ...
        output_file = test_utils.save_test_output(
            html, "test_variable_persistence")

        test_utils.assert_contains(html, '<p>a = 42</p>')
        test_utils.assert_contains(html, '<p>b = hello</p>')
        test_utils.assert_contains(html, '<p>c = 84</p>')

        print(
            f"✅ Variable persistence test passed - output saved to {output_file}")
...
"""
        ...
        test_utils.assert_contains(
            html, '<p>This text was generated by PyMD functions</p>')
...
"""
        ...
        print(
            f"✅ Code with strings test passed - output saved to {output_file}")
