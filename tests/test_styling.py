...
"""
        html = self.renderer.parse_and_render(content)
        output_file = test_utils.save_test_output(
            html, "test_code_output_styling")

        # Check code output structure (now rendered as paragraphs)
        test_utils.assert_contains(html, '<p>This is code output</p>')
        test_utils.assert_contains(html, '<p>With multiple lines</p>')
        ...
        print(
            f"✅ Code output styling test passed - output saved to {output_file}")
...
"""
        html = self.renderer.parse_and_render(content)
        output_file = test_utils.save_test_output(
            html, "test_comprehensive_styling")
        ...
        print(
            f"✅ Comprehensive styling test passed - output saved to {output_file}")
