...
from pymd.backend.app.api.v1 import auth, users, health, documents, render, environments, packages
...
app.include_router(packages.router, prefix=settings.API_V1_PREFIX, tags=["packages"])
